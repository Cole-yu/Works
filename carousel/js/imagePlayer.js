 ...
 */
var cArr = ["p5","p4","p3","p2","p1"];//p5是左边，p4是中间，p3是右边，这些css样式永远不变，通过隐藏展现3个页面
var $s = $(".buttons span");
var $a = $(".buttons a");
var index=0;
$(".next").click(function () {
...
function nextImg() {//通过改变类名来改变图片的位置，第一个li元素不断改变类名(p3,p1,p2),从而导致图片在网页中的位置也不断变化
    cArr.unshift(cArr[4]);//向开头添加p1
    cArr.pop();//把最后的p1删掉，最终数组是【p1,p5,p4,p3,p2】
    $("li").each(function (i, e) {//给li标签依次添加更新后的数组类名
